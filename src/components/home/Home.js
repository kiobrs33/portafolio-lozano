                ...
                <div className="home__content grid">
                    <div className="home__social">
                        <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" >
                            <i className="uil uil-linkedin-alt home__social-icon"></i>
                        </a>
                        <a href="https://github.com/" target="_blank" rel="noreferrer">
                            <i className="uil uil-github-alt home__social-icon"></i>
                        </a>
                    </div>
                    <div className="home__img">
                        <svg className="home__blob"  viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <g mask="url(#mask0)">
                                ...
                                <image className="home__blob-img" x="25" href="https://res.cloudinary.com/dks25ivcf/image/upload/v1628042174/portafolio/lz_bg2_cqfmjh.png" />
                            </g>
                        </svg>
                    </div>
